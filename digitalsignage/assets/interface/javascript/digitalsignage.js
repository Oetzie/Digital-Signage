...
;(function($, window, document, undefined) {
    ...
    */
    ...
    DigitalSignage.prototype.loadFeed = function() {
        ...
        $.ajax({
            url         : this.getAjaxUrl(this.settings.feed),
    ...
    DigitalSignage.prototype.loadCallback = function() {
        ...
        $.ajax({
            url         : this.getAjaxUrl(this.settings.callback),
                        ...
                        case 'JSON':
                            if (result.responseJSON) {
                                if (result.responseJSON.redirect) {
                                    window.location.href = result.responseJSON.redirect.replace(this.settings.domain, '');
                                }

                                if (result.responseJSON.restart) {
