...
<div class="window window-[[!+digitalsignage.player.mode]] window-[[!+digitalsignage.player.resolution]]">
    ...
    <div class="header">
        ...
        <div class="ticker" data-plugin="TickerPlugin" data-plugin-settings="{ 'feed': '[[!+digitalsignage.feed.feed]]', 'feedType': 'JSON' }">
                            ...
                            <div data-template="video">
                                <div class="video">
                                    <video muted autoplay>
                                        <source src="" data-placeholder="media" data-placeholder-renders="video" />
                                    </video>
                                </div>
