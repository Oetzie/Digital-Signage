...
class DigitalSignageBroadcastGetNodesProcessor extends modObjectGetListProcessor
{
    /**
     * @access public.
     * @var String.
    ...
    public function prepareRow(xPDOObject $object)
    {
        return array_merge($object->toArray(), [
            ...
            'calendar'  => $object->get('color')
        ]);
    }
}

return 'DigitalSignageBroadcastGetNodesProcessor';
