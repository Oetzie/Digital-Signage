...
class DigitalSignageBroadcastSlideGetListProcessor extends modObjectGetListProcessor
{
    /**
     * @access public.
     * @var String.
     ...
     * @var String.
     */
    public $defaultSortField = 'DigitalSignageBroadcastSlide.sortindex';
    ...
    public function prepareQueryBeforeCount(xPDOQuery $criteria)
    {
        ...
        $criteria->select($this->modx->getSelectColumns('DigitalSignageBroadcastSlide', 'DigitalSignageBroadcastSlide', null, ['id']));
...
return 'DigitalSignageBroadcastSlideGetListProcessor';
