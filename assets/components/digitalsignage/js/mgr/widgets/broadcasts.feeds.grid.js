DigitalSignage.grid.BroadcastFeeds = function(config) {
    ...
    var columns = new Ext.grid.ColumnModel({
        columns     : [{
            ...
            header      : _('digitalsignage.label_feed_slide_type'),
            ...
            header      : _('digitalsignage.label_feed_active'),
            dataIndex   : 'active',
            sortable    : true,
            editable    : true,
            width       : 100,
    ...
    Ext.applyIf(config, {
        ...
        fields      : ['id', 'broadcast_id', 'slide_type_id', 'key', 'url', 'time', 'frequency', 'active', 'editedon', 'slide_type_key', 'slide_type_name', 'slide_type_name_formatted', 'slide_type_icon'],
        paging      : true,
        pageSize    : 7,
        showPerPage : false,
        sortBy      : 'id'
    ...
    Ext.applyIf(config, {
        ...
        fields      : [{
            ...
            items       : [{
                ...
                items       : [{
                    xtype       : 'checkbox',
                    fieldLabel  : _('digitalsignage.label_feed_active'),
                    description : MODx.expandHelp ? '' : _('digitalsignage.label_feed_active_desc'),
                    name        : 'active',
                    inputValue  : 1,
                    checked     : true
                }, {
                    xtype       : MODx.expandHelp ? 'label' : 'hidden',
                    html        : _('digitalsignage.label_feed_active_desc'),
                    cls         : 'desc-under'
                }]
            }]
        }, {
            xtype       : 'digitalsignage-combo-slides-types',
            fieldLabel  : _('digitalsignage.label_feed_slide_type'),
            description : MODx.expandHelp ? '' : _('digitalsignage.label_feed_slide_type_desc'),
            name        : 'slide_type_id',
            anchor      : '100%',
            allowBlank  : false
        }, {
            xtype       : MODx.expandHelp ? 'label' : 'hidden',
            html        : _('digitalsignage.label_feed_slide_type_desc'),
            cls         : 'desc-under'
        }, {
            layout      : 'column',
            defaults    : {
