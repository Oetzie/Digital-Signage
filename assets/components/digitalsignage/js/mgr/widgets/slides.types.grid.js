DigitalSignage.grid.SlideTypes = function(config) {
    ...
    var columns = new Ext.grid.ColumnModel({
        columns     : [expander, {
            ...
            header      : _('digitalsignage.label_slide_type_active'),
            dataIndex   : 'active',
            sortable    : true,
            editable    : true,
            width       : 100,
    ...
    Ext.applyIf(config, {
        ...
        fields      : ['id', 'key', 'name', 'description', 'icon', 'time', 'data', 'active', 'editedon', 'name_formatted', 'description_formatted'],
        paging      : true,
    ...
    Ext.applyIf(config, {
        ...
        fields      : [{
            ...
            items       : [{
                ...
                items       : [{
                    xtype       : 'checkbox',
                    fieldLabel  : _('digitalsignage.label_slide_type_active'),
                    description : MODx.expandHelp ? '' : _('digitalsignage.label_slide_type_active_desc'),
                    name        : 'active',
                    inputValue  : 1,
                    checked     : true
                }, {
