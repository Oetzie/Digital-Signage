...
$package = 'DigitalSignae';

$permissions = [[
    'name'          => 'digitalsignage',
    'description'   => 'To view the digital signage package.',
    'templates'     => ['AdministratorTemplate']
], [
    'name'          => 'digitalsignage_admin',
    'description'   => 'To view the digital signage package, admin part.',
    'templates'     => ['AdministratorTemplate'],
